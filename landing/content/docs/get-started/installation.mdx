...
<Callout type="info">
  ...
  **`CALLBACK_URL`** — a publicly reachable URL where Chapa sends payment results. For local testing, use a tunnel like [ngrok](https://ngrok.com/) or [Cloudflare Tunnel](https://developers.cloudflare.com/cloudflare-one/connections/connect-networks/).
