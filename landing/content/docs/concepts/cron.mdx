...
|-------|-----------------|--------------|
| Reminder | Every day at 8am | Fires `subscription.reminder` events for subs approaching expiry. See [Reminders](/docs/concepts/reminders) for setup. |
...
|-------|---------|-------------|
| `mode` | — | Set to `"auto"` |
| `reminderSweepCron` | `0 8 * * *` | Cron expression for reminder check — see [Reminders](/docs/concepts/reminders) |
| `reminderLeadDays` | `[7, 3, 1]` | Days before expiry to send reminders — see [Reminders](/docs/concepts/reminders) |
...
| Serverless friendly | ❌ | ✅ | ✅ |
| Long-running apps | ✅ | ❌ | ✅ |
| Reminder sweep | ✅ | ✅ | ✅ — see [Reminders](/docs/concepts/reminders) |
