...
Defaults to `/api`. This must match the full path prefix where your BirrJS routes are mounted. For example, if your server uses `basePath: "/api/birrjs"`, pass `baseURL: "/api/birrjs"`.
